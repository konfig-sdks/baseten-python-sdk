...
class SecretsV1(
        ...
        class properties:
            ...
            class secrets(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SecretV1']:
                        return SecretV1
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SecretV1'], typing.List['SecretV1']],
                ...
                def __getitem__(self, i: int) -> 'SecretV1':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["secrets", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["secrets", ], str]):
